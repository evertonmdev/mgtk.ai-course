...
export async function googleGetSteps({
	...
	try {
		...
		const prompt = `I'm organizing an ebook about '${thema}'. I would like a numbered list with the sections of the ebook.
            
            Rules:
            
            Use only plain text, no markdown.
            Provide only the numbered list, no explanations.
